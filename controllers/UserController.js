...
//   try {
//     const { name, phone, patientId, reference, representativeName } = req.body;
//     if (!name || !phone || !patientId || !reference || !representativeName) {
//       return res.status(400).json({ message: 'All fields are required' });
//     }

//     const existingForm = await Insurance.findOne({ patientId });
//     if (existingForm) {
